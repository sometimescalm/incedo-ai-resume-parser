      ...
      <Layout.Content style={{ padding: 24, background: '#f0f2f5' }}>
        <Row gutter={16}>
          <Col span={12}>
            ...
            >
              <div style={{ height: "100vh", overflowY: "auto", paddingRight: 8 }}>

                <Form layout="vertical">
                  <Form.Item label={<strong>Profile Picture</strong>}>
                    <input
                      type="file"
                      accept="image/*"
                      ref={fileInputRef}
                  ...
                  <Form.Item label={<strong>Designation</strong>} required>
                    <Input
                      name="title"
                  ...
                  <Form.Item label={<strong>Summary</strong>} required>
                    <ReactQuill
                  ...
                  <Form.Item
                    label={<strong>Certifications</strong>}
                    required
                  >
                    <>
                      <Input
                      ...
                      <div style={{ marginTop: 8 }}>
                        {formData.certifications.map((cert, i) => (
                          <Tag
                            closable
                            key={i}
                            onClose={() => removeTag('certifications', cert)}
                          >
                            {cert}
                          </Tag>
                        ))}
                  ...
                  <Form.Item
                    label={<strong>Professional Skills</strong>}
                    required
                  >
                    <>
                      <Input
                      ...
                      {formData.education.map((edu, index) => (
                        <Card key={index} size="small" style={{ marginBottom: 16 }} type="inner">
                          ...
                          <Input
                            ...
                            value={edu.gpa}
                            onChange={(e) =>
                              handleNestedChange('education', index, 'gpa', e.target.value)
                            }
                            style={{ marginBottom: 8 }}
                          />
                          <Input
                            ...
                            value={edu.date}
                            onChange={(e) =>
                              handleNestedChange('education', index, 'date', e.target.value)
                            }
                            style={{ marginBottom: 8 }}
                          />
                          <Button
                      ...
                      {formData.projects.map((proj, index) => (
                        ...
                        >
                          ...
                          <Input.TextArea
                            ...
                            onChange={(e) =>
                              handleNestedChange('projects', index, 'description', e.target.value)
                            }
                            rows={3}
                          />
                          <Button
                  ...
                  <Form.Item
                    label={<strong>Work Experience</strong>}
                    required   
                  >
                    <>
                      {formData.work.map((job, index) => (
                        ...
                        >
                          <Input
                            ...
                            value={job.company}
                            onChange={(e) =>
                              handleNestedChange('work', index, 'company', e.target.value)
                            }
                            style={{ marginBottom: 8 }}
                          />
                          <Input
                            ...
                            value={job.title}
                            onChange={(e) =>
                              handleNestedChange('work', index, 'title', e.target.value)
                            }
                            style={{ marginBottom: 8 }}
                          />
                          <Input
                            ...
                            value={job.date}
                            onChange={(e) =>
                              handleNestedChange('work', index, 'date', e.target.value)
                            }
                            style={{ marginBottom: 8 }}
                          />
                          <ReactQuill
